...
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户收货地址' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `address` VALUES (12, 3, '打火机', '19612345678', '软件2302', 0, '2025-05-11 23:22:05', '2025-05-16 19:57:46');
INSERT INTO `address` VALUES (13, 19, '文档', '18936985474', '1111', 1, '2025-05-13 23:56:20', '2025-05-13 23:56:20');
INSERT INTO `address` VALUES (16, 3, '集合', '18798547123', '123', 0, '2025-05-16 19:48:05', '2025-05-16 19:57:46');
INSERT INTO `address` VALUES (20, 3, '都十分', '17845632104', '从v现场 ', 1, '2025-05-16 19:57:46', '2025-05-16 19:57:46');
INSERT INTO `address` VALUES (21, 3, '是的染色布', '17878954562', '急急急', 0, '2025-05-16 20:43:00', '2025-05-16 20:43:00');
...
-- Records of book
-- ----------------------------
INSERT INTO `book` VALUES (1, 3, '活着', '余华', 39.90, 83, 'http://localhost:8080/files/2004.jpg', '经典现实主义文学作品', 0, '2025-03-08 17:01:35', '2025-05-16 18:00:40');
...
INSERT INTO `book` VALUES (8, 1, '大师傅似的', '若是', 20.30, 99, 'http://localhost:8080/files/download/1746188367219_bf9d98b49a7d911a3618f85d29d66c471254371692.jpg', '大师傅士大夫', 1, '2025-05-02 01:07:13', '2025-05-16 17:58:55');
...
INSERT INTO `book` VALUES (25, 5, 'C语言', 'fdg', 36.00, 56, NULL, '666', 1, '2025-05-02 19:37:39', '2025-05-16 20:46:07');
...
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户购物车' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of cart
-- ----------------------------
INSERT INTO `cart` VALUES (27, 3, 3, 1, '2025-05-14 23:16:59', '2025-05-14 23:16:59');
INSERT INTO `cart` VALUES (28, 3, 2, 1, '2025-05-16 17:06:32', '2025-05-16 17:06:32');
...
CREATE TABLE `order_item`  (
  ...
  INDEX `book_id`(`book_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 33 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '订单明细表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `order_item` VALUES (32, 88, 8, 20.30, 1, '2025-05-16 17:58:56', '2025-05-16 17:58:56');
...
) ENGINE = InnoDB AUTO_INCREMENT = 89 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '订单主表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `orders` VALUES (88, 3, 'ORDER17473895356484862', 20.30, '已付款', 12, '2025-05-16 17:58:56', NULL, NULL, '2025-05-16 17:58:56', '2025-05-16 17:58:56');
