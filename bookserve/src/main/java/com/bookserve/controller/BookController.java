...
public class BookController {
    ...
    * */
    @GetMapping
    public Result getAllBook(@RequestParam(defaultValue = "1") Integer pageNum, @RequestParam(defaultValue = "5")
                             Integer pageSize, String name, String author, Integer status, String categoryName){


        PageResult bookList = bookService.getAllBook(pageNum, pageSize, name, author, status, categoryName);
